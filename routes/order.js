...
connection.connect(function (err) {
    if (err){
        ...
        var customerTableQuery="CREATE TABLE IF NOT EXISTS `order` (id VARCHAR(255) PRIMARY KEY ,cusId VARCHAR(255) ,date VARCHAR(255),CONSTRAINT FOREIGN KEY (cusId) REFERENCES customer(id) )"
