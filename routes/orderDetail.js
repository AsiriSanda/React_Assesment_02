...
connection.connect(function (err) {
    if (err) {
        ...
        var customerTableQuery = "CREATE TABLE IF NOT EXISTS orderDetail (orderId VARCHAR(255), itemCode VARCHAR(255), orderQty int(10), price double, CONSTRAINT PRIMARY KEY (orderId,itemCode),CONSTRAINT FOREIGN KEY (orderId) REFERENCES `order`(id),CONSTRAINT FOREIGN KEY (itemCode) REFERENCES item(id))"
